...
def find_two_word_anagrams(target: str, valid_words: list[str]) -> set[tuple[str, str]]:
    ...
    """
    # TODO : Implémenter la logique ici en respectant les principes du Clean Code.
    pass
...
class TestTwoWordAnagrams(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dictionary = [
            "a", "c", "cat", "act", "o", "to", "cot", "at", "taco", "doc", "men", "ting"
        ]
    ...
    def test_target_with_exact_dictionary_match(self):
        target = "cot"
        # "c" n'est pas dans le dictionnaire avec un "ot" valide,
        # "cot" est un seul mot, le kata demande DEUX mots.
        expected = set()
    ...
    def test_complex_anagram(self):
        ...
        expected = {
            ("document", "ing"), ("ing", "document"),
            ("doc", "umenting"), ("umenting", "doc"),
            ("do", "cumenting"), ("cumenting", "do")
        }
